...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(
        ...
        "Send me a YouTube video or Shorts link and I'll convert it into a high-quality MP3.\n\n"
        "👇 Choose an option below or simply send a YouTube link.",
        parse_mode="Markdown",
...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if text == "🎵 Convert Audio":
        await update.message.reply_text("📥 Please send me a YouTube video or Shorts URL.")
        return
    elif text == "❓ Help":
        ...
        await update.message.reply_text(
            "🎵 GRAB AUDIO\n\nConvert YouTube videos into high-quality MP3 audio.\n\nSimply send a public YouTube URL and I'll do the rest."
        )
        return
